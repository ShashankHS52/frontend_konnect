...
import { invites as initialInvites, type Invite } from '@/lib/placeholder-data';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/ui/table';
import { Badge, type BadgeProps } from '@/components/ui/badge';

const statusVariants: { [key in Invite['status']]: BadgeProps['variant'] } = {
    Active: 'default',
    Used: 'secondary',
    Expired: 'destructive',
};
...
export function InviteGenerator() {
  ...
  const [newlyGeneratedInvite, setNewlyGeneratedInvite] = useState<Invite | null>(null);
